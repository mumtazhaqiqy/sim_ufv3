 ...
 */
$config['site_title']                 = "devidea.id";         // Site Title, example.com
$config['admin_email']                = "support@devidea.id"; // Admin Email, admin@example.com
...
$config['maximum_login_attempts']     = 1000;                      // The maximum number of failed login attempts.
