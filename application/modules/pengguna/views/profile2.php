                ...
                <li class="list-group-item">
                    <div class="progress-group pl-4 mt-5">
                        ...
                        <div class="progress sm">
                            <div class="progress-bar progress-bar-aqua" style="width: <?= $profile_pengguna->sudah_sertifikasi / $profile_pengguna->jumlah_guru ?>%"></div>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <div class="row mt-12">
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="small-box bg-grey">
                    ...
                    <a href="<?=base_url()?>pengguna/guru_quran" class="small-box-footer">Lihat daftar <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-sm-6 col-xs-12">
                <!-- small box -->
                <div class="small-box bg-grey">
                    ...
                    <a href="<?=base_url()?>pengguna/perkembangan_siswa" class="small-box-footer">Lihat Perkembangan<i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
