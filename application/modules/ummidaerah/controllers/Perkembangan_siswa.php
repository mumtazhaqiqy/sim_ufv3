...
class Perkembangan_siswa extends MY_Controller
{
    ...
    public function index($customer_id)
    {
        ...
        $crud->set_subject("Perkembangan Siswa");
        ...
        if ($state == 'add') {
            ...
            redirect('/ummidaerah/perkembangan_siswa/add/'.$customer_id);
        }
        ...
        $template_data["title"] = "Perkembangan Siswa";
    ...
    public function edit()
    {
        ...
        $customer = db_get_row('view_pengguna', 'id_customer ='.$customer_id);
        ...
        if ($unique == null) {
            ...
            $template_data["title"] = "Edit Perkembangan Siswa";
            $template_data["crumb"] = ["table" => ""];
            $this->layout->auth();
            $this->layout->render('blank', $template_data); // front - auth - admin
        }
    ...
    public function save($customer_id)
    {
        ...
        if ($this->input->get('method') == 'edit') {
            ...
            if (count($checkunique) == 1) {
                ...
                redirect('/ummidaerah/perkembangan_siswa/index/'.$customer_id);
            }
        }
